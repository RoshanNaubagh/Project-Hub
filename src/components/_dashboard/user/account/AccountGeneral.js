          ...
          <Grid item xs={12} md={8}>
            <Card sx={{ p: 3 }}>
              <Stack spacing={{ xs: 2, md: 3 }}>
                ...
                <Stack direction={{ xs: 'column', md: 'row' }} spacing={2}>
                  <TextField fullWidth label="Organization Name" {...getFieldProps('phoneNumber')} />
                  <TextField fullWidth disabled label=" Secondary Email Address" {...getFieldProps('email')} />
                </Stack>
