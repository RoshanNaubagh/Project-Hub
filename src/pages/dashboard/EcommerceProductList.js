              ...
              <Table>
                ...
                <TableBody>
                  {filteredProducts.slice(page * rowsPerPage, page * rowsPerPage + rowsPerPage).map((row) => {
                    const { id, productTitle, productImage, productStatus } = row;
                    ...
                    return (
                      ...
                      >
                        ...
                        <TableCell component="th" scope="row" padding="none">
                          ...
                          >
                            <ThumbImgStyle alt="" src={`${process.env.REACT_APP_API_URL}/${productImage}`} />
                            <Typography variant="subtitle2" noWrap>
                              {productTitle}
                            </Typography>
                          </Box>
                        </TableCell>
                        <TableCell style={{ minWidth: 160 }}>{productStatus}</TableCell>

                        <TableCell style={{ minWidth: 80 }}>{id}</TableCell>
                        <TableCell style={{ minWidth: 160 }}>Sample</TableCell>
                        <TableCell style={{ minWidth: 160 }}>Sample</TableCell>
                        <TableCell align="right">
                          <ProductMoreMenu onDelete={() => handleDeleteProduct(id)} productName={productTitle} />
                        </TableCell>
                      </TableRow>
                    );
                  })}
